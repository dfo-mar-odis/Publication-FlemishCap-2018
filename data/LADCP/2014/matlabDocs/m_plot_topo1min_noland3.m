...
function topo1min = m_plot_topo1min_noland(figtitle,latmax,latmin,lonmax,lonmin,lat_points,lon_points,slist)
%input
% title=input('enter name for map')
...
% [cs h]=m_contour(lon,lat,elevations,[-100 -200 -300 -400 -500 -1000 -1500 -2000 -2500 -3000 -3500 -4000 -4500 -5000 -5500 -6000]);
[cs h]=m_contour(lon,lat,elevations,[0 -100 -200 -300 -400 -500 -1000 -1500 -2000 -2500 -3000 -3500 -4000]);
