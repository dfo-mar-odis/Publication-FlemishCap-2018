...
a.raw= 'U:\Ladcp\HUD2013021_Flem_softwareUPDATE\raw'; % dirctory with LADCP data
a.processed='U:\Ladcp\HUD2013021_Flem_softwareUPDATE\processed'; % dirctory with processed LADCP data
...
% stnnumber(1)=[]; %remove cast 2 Bedford Basin test
...
stnnumtransect1=stnnumber(2:14); 
transect1=[stnnumtransect1]; name1='transect1';
stnnumtransect2=stnnumber(15:27);
transect2=[stnnumtransect2]; name2='transect2';
stnnumtransect3=stnnumber(30:40);  
transect3=[stnnumtransect3]; name3='transect3';
nontransect=stnnumber([1 28 29 ]);
transect4=[nontransect]; name4='transect4'; %not used
...
G_Creatbins(a,bins,binsize,radius)%radius% can not run unless all stations were run C_aligncurrents_withbath3point_new2 you need HUDLADCP to have values for the ualign and valign
...
I_SectionPlot_notrotated_nomap(a,transect2,name2) ;
close all

I_SectionPlot_aligned(a,transect1,name1,radius) ;
close all

I_SectionPlot_notrotated(a,transect3,name3) ;
